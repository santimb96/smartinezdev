        ...
        <section id='contact' className='w-full scroll-m-20 pb-[10px]'>
            ...
            <div className='w-full flex-wrap lg:flex-nowrap flex flex-col justify-start items-start gap-2.5 lg:flex-row'>
                ...
                <div className='flex justify-start items-start lg:flex-col gap-2.5 flex-wrap lg:w-1/2 mt-5 lg:mt-0'>
                    <a href='mailto:santiagomartinezbota@gmail.com' target='_blank' rel='noreferrer' aria-label='Enviar correo a Santiago Martínez' className='buttonLink flex justify-start items-center gap-5 lg:w-full'>
                        <span className='lucideIcon'>
                            <Mail strokeWidth={2} />
                        </span>
                        <span>Correo electrónico</span>
                    </a>
                    <a href='https://www.linkedin.com/in/santi-martinez-bota/' target='_blank' rel='noreferrer' aria-label='Ver perfil de LinkedIn de Santiago Martínez' className='buttonLink lg:w-full'>
                        <span className='lucideIcon'>
                            <LinkedInIcon strokeWidth={2} />
                        </span>
                        <span>LinkedIn</span>
                    </a>
                    <a href='https://github.com/santimb96' target='_blank' rel='noreferrer' aria-label='Ver perfil de GitHub de Santiago Martínez' className='buttonLink lg:w-full'>
                        <span className='lucideIcon'>
            ...
            <div className='mt-20 w-full flex flex-col justify-center items-center'>
                ...
                <div className='mt-5 flex justify-center items-center gap-5'>
                    <a href="https://www.linkedin.com/shareArticle?url=https://smartinezdev.com&title=Portfolio%20de%20Santiago%20Martínez&summary=Un%20portfolio%20desarrollado%20con%20ReactJS%20y%20TailwindCSS.&source=SmartinezDev" target="_blank" rel='noreferrer' aria-label='Compartir portfolio en LinkedIn' className='min-w-6 hover:text-[var(--detail)] duration-150 ease-in-out'>
